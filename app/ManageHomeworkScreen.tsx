...
export default function ManageHomeworkScreen() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            setTotalClasses(11); // Hardcoded for now
            setClasses([
                { grade: 'Grade - 10', class: 'A', subject: 'Science' },
                { grade: 'Grade - 10', class: 'B', subject: 'Science' },
                { grade: 'Grade - 10', class: 'C', subject: 'Science' },
                { grade: 'Grade - 11', class: 'A', subject: 'Science' },
                { grade: 'Grade - 11', class: 'D', subject: 'Science' },
                { grade: 'Grade - 12', class: 'A', subject: 'Bio Art' },
                { grade: 'Grade - 12', class: 'E', subject: 'Bio Art' },
                { grade: 'Grade - 13', class: 'F', subject: 'Bio' },
            ]);
        };
        fetchData();
    }, []);
    ...
    const handleClassPress = (item) => {
        // Navigate to a new screen with class details (e.g., '/HomeworkDetailScreen')
        router.push({
            pathname: '/HomeworkDetailScreen',
            params: { grade: item.grade, class: item.class, subject: item.subject },
        });
    };
...
const styles = StyleSheet.create({
    ...
    yearBox: { flexDirection: 'row', justifyContent:"center", height: 48, alignItems:"center", backgroundColor: '#E0E0E0', borderRadius: 5, padding: 10, marginBottom: 20 },
